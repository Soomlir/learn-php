<?php
$arr = [1, 2, 3, 4];
echo count($arr); // считает количество элементов в массиве

$arr[] = 7; // что-то добавляем в конец массива
...
// array_key_exists -  Проверяет наличие ключей в массиве (true || false)
$search_array = array('first' => 1, 'second' => 4);

// array_key_exists - возвращает true или false
if (array_key_exists('first', $search_array)) { // проверяет существует ли ключ в массиве
...
// При $result = $array1 + $array2 - Значения не перезаписываются, из 2 массива берем не повторяющиеся значения
...
//        'event' => $event
//    ];
$result = compact('city', 'state', 'event'); // передаем название переменных в виде строк
